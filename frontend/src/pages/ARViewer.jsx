      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="aspect-video bg-gray-900 dark:bg-black rounded-lg flex items-center justify-center relative overflow-hidden">
                {cameraActive ? (
              ...
              <div className="mt-4 space-y-3">
                ...
                {isARSupported && (
                  <div className="bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 text-green-700 dark:text-green-400 px-4 py-2 rounded-lg text-sm">
            ...
            <CardContent className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 p-4 rounded-lg">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900 dark:text-blue-100">AR Visualization</h4>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border dark:border-gray-700">
